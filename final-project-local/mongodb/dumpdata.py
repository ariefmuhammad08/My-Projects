...
if __name__ == "__main__" :
    ...
    # connect to mongodb
    client = pymongo.MongoClient("link_mongodb_disini")
    ...
    # insert to postgres
    zipsDF.to_sql('zips', engine, if_exists='replace', index=False)
    compDF.to_sql('companies', engine, if_exists='replace', index=False)
